...
# class Config(collections.Mapping): # < Python 3.10
class Config(collections.abc.Mapping): # >= Python 3.10
    ...
    def __call__(self, *args, **kwargs):
        ...
        if self._device:
            ...
            # instance = instance.to("cuda:1")
        # if self._device and self._device=="cuda:0":
            # instance = instance.to(self._device)
        return instance
