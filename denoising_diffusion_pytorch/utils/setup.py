...
class Parser(Tap):
    ...
    def save(self):
        ...
        super().save(fullpath, skip_unpicklable=False)

    def save2(self,args):
        fullpath = self.savepath
        print(f'[ utils/setup ] Saved args to {fullpath}')
        shutil.copy(self.config_dir,self.savepath)

    def save_config_file(self,save_path):
        print(f'[ utils/setup ] Saved args to {save_path}')
        shutil.copy(self.config_dir,save_path)
    ...
    def read_config(self, args, experiment):
        ...
        self.config_dir = module.__file__
