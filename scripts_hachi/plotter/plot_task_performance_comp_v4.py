...
if __name__ == '__main__':
    ...
    save_tag   = "baseline_method_comparison_v3"
    # save_tag   = "learning_performance_comparison_v2"
    # save_tag   = "cond_ablation_v6"
    # save_tag   = "observation_type_ablation_v4"
    ...
    # root_dir1   = "/home/user/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/diffusion_plans/real_model/real_models_dataset_v2_1/dataset_SheetSander_024_eval/PT140000_B16_T15_fix_start_multi_step_partial_obs_a73_vaeac_cal_cost_mean_ucb_v1_1"
    # root_dir2   = "/home/user/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/diffusion_plans/real_model/real_models_dataset_v2_1/dataset_SheetSander_024_eval/PT140000_B16_T15_fix_start_multi_step_partial_obs_a17_vaeac_cal_cost_mean_ucb_v1_1"
    # root_dir3   = "/home/user/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/diffusion_plans/real_model/real_models_dataset_v2_1/dataset_SheetSander_024_eval/PT140000_B32_T15_fix_start_multi_step_partial_obs_a73_diffusion_cal_cost_mean_ucb_v1_1"
    
    # root_dir1   = "/home/user/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/diffusion_plans/real_model/real_models_dataset_v2_1/dataset_SheetSander_024_eval/PT140000_B32_T15_fix_start_multi_step_partial_obs_a17_diffusion_cal_cost_mean_ucb_v1_1"
    # root_dir2   = "/home/user/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/diffusion_plans/real_model/real_models_dataset_v2_1/dataset_SheetSander_024_eval/PT140000_B32_T15_fix_start_multi_step_partial_obs_a17_diffusion_cal_cost_mean_ucb_v1_1"
    # root_dir3   = "/home/user/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/diffusion_plans/real_model/real_models_dataset_v2_1/dataset_SheetSander_024_eval/PT70000_B32_T15_fix_start_multi_step_partial_obs_a73_diffusion_cal_cost_mean_ucb_v1_1"
    # root_dir4   = "/home/user/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/diffusion_plans/real_model/real_models_dataset_v2_1/dataset_SheetSander_024_eval/PT140000_B32_T15_fix_start_multi_step_partial_obs_a73_diffusion_cal_cost_mean_ucb_v1_1"



    # root_dir1   = "/home/user/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/diffusion_plans/real_model/real_models_dataset_v2_1/dataset_SheetSander_024_eval/PT140000_B32_T15_fix_start_multi_step_partial_obs_a73_diffusion_cal_cost_mean_ucb_v1_1"
    # root_dir2   = "/home/user/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/diffusion_plans/real_model/real_models_dataset_v2_1/dataset_SheetSander_024_eval/PT140000_B32_T15_fix_start_multi_step_partial_obs_a73_diffusion_cal_cost_mean_ucb_v1_1"
    # root_dir3   = "/home/user/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/diffusion_plans/real_model/real_models_dataset_v2_1/dataset_SheetSander_024_eval/PT140000_B32_T15_fix_start_multi_step_both_cs_obs_a73_diffusion_cal_cost_mean_ucb_v1_1"


    # root_dir1   = "/home/user/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/diffusion_plans/real_model/real_models_dataset_v2_1/dataset_SheetSander_024_eval/PT140000_B32_T15_fix_start_multi_step_partial_obs_a19_diffusion_cal_cost_mean_ucb_v2_1"
    # root_dir2   = "/home/user/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/diffusion_plans/real_model/real_models_dataset_v2_1/dataset_SheetSander_024_eval/PT140000_B32_T15_fix_start_multi_step_partial_obs_a19_diffusion_cal_cost_mean_ucb_v2_1"
    # root_dir3   = "/home/user/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/diffusion_plans/real_model/real_models_dataset_v2_1/dataset_SheetSander_024_eval/PT140000_B32_T15_fix_start_multi_step_both_cs_obs_a73_diffusion_cal_cost_mean_ucb_v1_1"

    root_dir1   = "/home/user/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/diffusion_plans/real_model/real_models_dataset_v2_1/dataset_SheetSander_024_eval/PT140000_B32_T8_fix_start_multi_step_partial_obs_a17_diffusion_cal_cost_mean_ucb_v1_4"
    root_dir2   = "/home/user/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/diffusion_plans/real_model/real_models_dataset_v2_1/dataset_SheetSander_024_eval/PT140000_B16_T8_fix_start_multi_step_partial_obs_a17_vaeac_cal_cost_mean_ucb_v1_4"
   
    # root_dir1   = "/home/user/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/diffusion_plans/real_model/real_models_dataset_v2_1/dataset_SheetSander_024_eval/PT140000_B32_T15_fix_start_multi_step_partial_obs_a19_diffusion_cal_cost_mean_ucb_v1_1"
    # root_dir2   = "/home/user/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/diffusion_plans/real_model/real_models_dataset_v2_1/dataset_SheetSander_024_eval/PT140000_B32_T15_fix_start_multi_step_partial_obs_a19_diffusion_cal_cost_mean_ucb_v1_2"
    # root_dir1   = "/home/user/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/diffusion_plans/real_model/real_models_dataset_v2_1/dataset_SheetSander_024_eval/PT140000_B16_T15_fix_start_multi_step_partial_obs_a19_vaeac_cal_cost_mean_ucb_v1_1"
    ...
    # data_list =[data_dict_1,data_dict_3]
    ...
    for idx,val in enumerate(data_dict_1["data_0"].keys()):
        ...
        color_set       = ["#66cdaa","#9370db", "#f4a460",'#808080']
        ...
        for i in range(len(data_list)):
            ...
            if "no_cond" in data_list[i]["data_path"]["data_0"] or "epsilon_greedy_00" in data_list[i]["data_path"]["data_0"] :
                ...
                if "vaeac" in data_list[i]["data_path"]["data_0"] is not True:
                    ...
                    ax4.set_xticks( np.arange(start=0, stop=7, step=2))
        ...
        for i in range(len(data_list)):
            ...
            with open(f"{save_name}.txt", "w") as file:
                ...
                print(f"Proposed-Nocond & {np.round(data_dict_2['data_0'][val]['reward_mean'],2)} $\pm${np.round(data_dict_2['data_0'][val]['reward_std'],2)} & {np.round(data_dict_2['data_0'][val]['removal_trans'][-1],2)} $\pm${np.round(data_dict_2['data_0'][val]['removal_trans_std'][-1],2)} & {np.round(data_dict_2['data_0'][val]['removal_performance'][-1],2)} $\pm${np.round(data_dict_2['data_0'][val]['removal_performance_std'][-1],2)}",file=file)
                print(f"Proposed        & {np.round(data_dict_1['data_0'][val]['reward_mean'],2)} $\pm${np.round(data_dict_1['data_0'][val]['reward_std'],2)} & {np.round(data_dict_1['data_0'][val]['removal_trans'][-1],2)} $\pm${np.round(data_dict_1['data_0'][val]['removal_trans_std'][-1],2)} & {np.round(data_dict_1['data_0'][val]['removal_performance'][-1],2)} $\pm${np.round(data_dict_1['data_0'][val]['removal_performance_std'][-1],2)}",file=file)
                print(f"Proposed-GT     & {np.round(data_dict_3['data_0'][val]['reward_mean'],2)} $\pm${np.round(data_dict_3['data_0'][val]['reward_std'],2)} & {np.round(data_dict_3['data_0'][val]['removal_trans'][-1],2)} $\pm${np.round(data_dict_3['data_0'][val]['removal_trans_std'][-1],2)} & {np.round(data_dict_3['data_0'][val]['removal_performance'][-1],2)} $\pm${np.round(data_dict_3['data_0'][val]['removal_performance_std'][-1],2)}",file=file)
