...
base = {
    ...
    'conditional_image_diffusion': {
        ...
        ## serialization
        'logbase'           : 'logs',
        'prefix'            : 'conditional_diffusion/',
        # 'tag'               : "flower_image_v1",
        'tag'               : "dataset_13901k_v2",
    ...
    'diffusion_plan': {
        ...
        'policy'            :'policy.cutting_surface_planner_v9.cutting_surface_planner',
        # 'batch_size'        : 16,
        ...
        # 'diffusion_loadpath': 'f:/home/{USER_NAME}/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/diffusion/T1000_D64_dataset_4142435161_13901k_v1',
        # 'diffusion_loadpath': 'f:/home/{USER_NAME}/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/conditional_diffusion/T1000_D64_dataset_13901k_v7',
        'diffusion_loadpath': 'f:/home/{USER_NAME}/workspace/denoising_diffusion_pytorch/logs/Image_diffusion_2D/conditional_diffusion/T1000_D64_dataset_13901k_v7',
        ...
        # 'iter'              : [0,2],
        # 'iter'              : [0,10],
        'tag'               : 'f:T1000_D64_B{batch_size}_test_v6_fix_start_multi_step_partial_obs_a{start_action_idx}_long_{policy_config["infer_model"]}_{policy_config["decision_mode"]["mode"]}_9_t20_8_3_tmp13_3',
