...
if __name__ == '__main__':
    ...
    for idx,val in enumerate(data_dict_1["data_0"].keys()):
        ...
        bars    = np.arange(len(heights))
        ax2.bar(bars, heights, yerr=std, align='center', alpha=1.0, ecolor='black',color = color_set, capsize=10)
        ...
        bars    = np.arange(len(heights))
        ax3.bar(bars, heights, yerr=std, align='center', alpha=1.0, ecolor='black',color = color_set, capsize=10)
